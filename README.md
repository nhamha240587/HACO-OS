...
- **Is it really 100% AI-coded?** Yes — every line was generated by Claude Code. I act as the architect (data model, business rules, security boundaries, workflows) and review + test each change. Strict TypeScript (no `any`) and CI lint+build on every push keep quality up.
